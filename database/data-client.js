...
function createUser(user) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const addedUser = yield prisma.user.create({
            data: {
...
function verifyUserCredentials(verifyUser) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield bcrypt_1.default.compare(verifyUser.password, user.password);
    });
}
